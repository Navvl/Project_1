          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Surat</h5>
              </div>
              <div class="card-body">
                <form  action="<?=base_url('home/aksi_buat_surat')?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Surat</label>
                        <select name="surat" id="status" class="form-control">
                            <option value="Pilih">Pilih</option>
                            <option value="Ada Surat">Ada Surat</option>
                            <option value="Tidak Ada Surat">Tidak Ada Surat</option>
                        </select>
                      </div>
                    </div>

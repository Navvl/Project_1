  ...
  <div class="col-lg-3"> <!-- Kolom pertama, setengah lebar -->
    <div class="card">
        <div class="card-body">
            ...
            <!-- Form PDF -->
            <form action="<?= base_url('home/aksi_laporan_pdf_admin') ?>" method="get" enctype="multipart/form-data">
                <!-- Input Tanggal Mulai -->
                <div class="row mb-3">
    ...
    <div class="col-lg-3"> <!-- Kolom kedua, setengah lebar -->
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form Excel -->
          <form action="<?= base_url('home/aksi_laporan_excel_admin') ?>" method="POST" enctype="multipart/form-data">
            <!-- Input Tanggal Mulai -->
            <div class="row mb-3">
              <label for="mulai" class="col-sm-4 col-form-label">Tanggal Mulai</label>
              <div class="col-sm-8">
  ...
  <div class="col-lg-3"> <!-- Kolom pertama, setengah lebar -->
    <div class="card">
        <div class="card-body">
            ...
            <!-- Form PDF -->
            <form action="<?= base_url('home/windows_print_admin') ?>" method="POST" enctype="multipart/form-data">
                <!-- Input Tanggal Mulai -->
                <div class="row mb-3">
                    <label for="mulai" class="col-sm-4 col-form-label">Tanggal Mulai</label>
                    <div class="col-sm-8">
